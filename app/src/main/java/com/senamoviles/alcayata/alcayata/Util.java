...
public class Util {
    ...
    public static GradientDrawable getOvalDrawable(View view, int color) {
        GradientDrawable gradientDrawable = (GradientDrawable) getDrawable(
                view,
                com.nightonke.boommenu.R.drawable.shape_oval_normal);
    ...
    public static GradientDrawable getRectangleDrawable(View view, int cornerRadius, int color) {
        GradientDrawable gradientDrawable = (GradientDrawable) getDrawable(
                view,
                com.nightonke.boommenu.R.drawable.shape_rectangle_normal);
    ...
    public static int getColor(
            ...
            int id,
            int defaultId) {
        return typedArray.getColor(id, com.nightonke.boommenu.Util.getColor(typedArray, defaultId));
    }
    ...
    private static com.senamoviles.alcayata.alcayata.Util ourInstance = new com.senamoviles.alcayata.alcayata.Util();
